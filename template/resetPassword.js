...
var TemplateResetPassword= (name,token)=>{
    return   `
    ...
    width: 100% !important;
     ...
     opacity: 1 !important">
                ...
                margin-bottom: 40px;
                ">  
                <span>¡Hola! Acaba de iniciar una solicitud para restablecer la contraseña en la cuenta de financiacionparasembrar.com</span>
                    <br>
                    <br>
                    <span>Confirme su restablecimientode contraseña por enlace: </span> <br>
                    <a href="http://localhost:4200/restablecer-contrasena/${token}" style="text-align:center;border-radius:10px;background-color:#00c48c;padding:10px 30px;color:white;display:inline-block;margin-top:15px;text-decoration:none" target="_blank" >Restablecer  contraseña </a>
                </section>
                </section>
